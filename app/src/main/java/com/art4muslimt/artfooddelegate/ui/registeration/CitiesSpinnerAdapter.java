...
public class CitiesSpinnerAdapter extends BaseAdapter {
    ...
    Context c;
    List<CityResponse.DataEntity> objects;

    public CitiesSpinnerAdapter(Context context, List<CityResponse.DataEntity> objects) {
        super();
        this.c = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CityResponse.DataEntity cur_obj = objects.get(position);
